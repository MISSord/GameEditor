...
namespace EGamePlay
{
    ...
    {
        private static readonly List<ITypeDrawer> _typeDrawers = new List<ITypeDrawer>();
        ...
        public static void Draw(object obj)
        {
            try
            {
                ...
                foreach (FieldInfo fieldInfo in fields)
                {
                    ...
                    foreach (ITypeDrawer typeDrawer in _typeDrawers)
                    {
            ...
            {
                GameLog.Error($"component view error: {obj.GetType().FullName}");
            }
        }
    }
}