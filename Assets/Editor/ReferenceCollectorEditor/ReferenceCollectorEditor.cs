...
public class ReferenceCollectorEditor: Editor
{
    ...
    private string searchKey
	{
		...
		set
		{
			...
			{
				_searchKey = value;
				_heroPrefab = _referenceCollector.Get<Object>(searchKey);
			}
		}
	}
	...
	private void OnEnable()
	{
        ...
        _referenceCollector = (ReferenceCollector) target;
	}
	...
	public override void OnInspectorGUI()
	{
        ...
        for (int i = _referenceCollector.data.Count - 1; i >= 0; i--)
		{
			GUILayout.BeginHorizontal();
