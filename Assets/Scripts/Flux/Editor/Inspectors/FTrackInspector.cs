...
namespace FluxEditor
{
	...
	public class FTrackInspector : Editor {
		...
		public override void OnInspectorGUI()
		{
            ...
            GUI.enabled = false;
            EditorGUILayout.ObjectField("Timeline", track.Timeline, typeof(UnityEngine.Object), true);
            EditorGUILayout.ObjectField("Track", track, typeof(UnityEngine.Object), true);
            GUI.enabled = true;
