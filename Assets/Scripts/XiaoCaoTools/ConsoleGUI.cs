...
namespace Consolation
{
    ...
    class ConsoleGUI : MonoBehaviour
    {
        ...
        public static ConsoleGUI Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    _instance = obj.AddComponent<ConsoleGUI>();
        ...
        private RectOffset _toggleOffset;
        ...
        private void SetStyle()
        {
            ...
            _toggleOffset = toggleStyle.margin;
            isStarted = true; ;
        }
        ...
        void DrawToolbar()
        {
            ...
            _toggleOffset.top = (int)toggleOffsetY;
            toggleStyle.margin = _toggleOffset;
